...
static void key_event_cb(ClutterActor *actor, ClutterKeyEvent *event, gpointer data)
{
	...
	app->foo_sound->setPosition(clutter_actor_get_x(app->foo_actor), clutter_actor_get_y(app->foo_actor), 0);
...
int main(int argc, char *argv[])
{
    ...
    ExampleApplication *app = g_new0(ExampleApplication, 1);
    ...
    clutter_actor_set_anchor_point_from_gravity(app->foo_actor, CLUTTER_GRAVITY_CENTER);
    clutter_actor_set_size(app->foo_actor, 50.0f, 50.0f);
    clutter_actor_set_position(app->foo_actor, WINDOW_WIDTH / 2.0f, WINDOW_HEIGHT / 2.0f);
